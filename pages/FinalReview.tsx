      ...
      <main className="flex-1 py-8 px-4 flex flex-col items-center gap-6">
        <div className="w-full max-w-5xl flex flex-col md:flex-row justify-between items-center gap-4 bg-white p-5 rounded-2xl shadow-sm border border-gray-200 z-20">
           ...
           <div className="flex gap-4">
              ...
              <button onClick={() => navigate('/success')} className="flex items-center gap-2 px-6 py-2.5 bg-navy-900 text-white rounded-xl font-bold text-sm hover:bg-navy-800 transition-all shadow-lg shadow-navy-900/20 transform hover:-translate-y-0.5">
