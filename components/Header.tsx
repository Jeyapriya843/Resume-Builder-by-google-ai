    ...
    <nav className="sticky top-0 z-50 w-full bg-white/80 backdrop-blur-md border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link to="/pricing" className="text-gray-600 hover:text-navy-900 text-sm font-medium transition-colors">Pricing</Link>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden absolute top-16 left-0 w-full bg-white border-b border-gray-100 shadow-xl p-4 flex flex-col gap-4">
           <Link to="/templates" className="text-gray-600 font-medium p-2">Templates</Link>
           <Link to="/pricing" className="text-gray-600 font-medium p-2">Pricing</Link>
           <Link to="/builder" className="bg-navy-900 text-white text-center py-3 rounded-lg font-semibold">Build Resume</Link>
        </div>
      )}
    </nav>
  );
