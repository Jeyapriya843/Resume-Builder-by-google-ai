...
export const steps = [
  ...
  { id: 'certifications', label: 'Certifications', icon: Icons.CheckCircle, path: '/builder/certifications' },
  { id: 'languages', label: 'Languages', icon: Icons.Globe, path: '/builder/languages' },
